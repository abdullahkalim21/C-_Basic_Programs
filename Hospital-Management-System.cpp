...
/*
    This program was done with the help of 2 other class fellows as Final Project in the second semester
    Muhammad Ammar Qaisar & Muhammad Areeb Khan
*/
...
int main()
{
    ...
    cout << "Muhammad Areeb Khan Chommu" << endl;
