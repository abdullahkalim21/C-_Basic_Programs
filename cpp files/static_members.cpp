...
/*
    ...
    For declaring, the basic difference of other data members and static data members is that static data members have STATIC keyword in the beginning
    SYNTAX:
        static data_type data_member;

    You must define the static data members outside the class.
    Following is the syntax for defining:
    SYNTAX:
...
// How can you access a static data member outside of the class? Demonstrate with an example.
/*
    static data members can be accessed using a scope resolution operator (::) after the class name and following the static data member's name.
    SYNTAX:
...
/*
    ...
    If we initialize the static member within constructor, the compiler shows the following error
...
/*
    Imagine a scenario where you are designing a class for a bank account system. You need to keep track of the total number of accounts created. Implement this using a static data member. How would you ensure that this count increases with each new account?
*/
/*
class Account {
    private:
...
/*
    Static member functions are same as the other member functions but the key difference is that static member functions can only access static data members & this pointer is not used in static member functions
    Using this pointer:
